...
main() {
  ...
  readonly show_directory_in_window_status_current="#[fg=colour232,bg=$thm_orange] #I#[fg=$thm_orange,bg=colour237]$left_separator#[fg=colour255,bg=colour237] #(echo '#{pane_current_path}' | rev | cut -d'/' -f-2 | rev)#[fg=colour237,bg=$thm_bg]$left_separator"
